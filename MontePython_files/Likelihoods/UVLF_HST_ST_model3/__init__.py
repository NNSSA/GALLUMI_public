...
class UVLF_HST_ST_model3(Likelihood):
    ...
    def __init__(self, path, data, command_line):
        ...
        # Fitting parameters for Mstar-MUV relation from table 1 in 1507.05636 (z = 4-5) and table 3 in 2103.16571 (z = 6-10)
        self.Mstar_fit_a = {4:-0.54, 5:-0.5, 6:-0.57, 7:-0.49, 8:-0.49, 9:-0.46, 10:-0.41}
        self.Mstar_fit_b = {4:9.7, 5:9.59, 6:9., 7:8.9, 8:8.8, 9:8.6, 10:8.5}
        self.Mstar_fit_anchor = {4:21, 5:21, 6:20.5, 7:20.5, 8:20.5, 9:20.5, 10:20.5}
    ...
    # Obtain average <MUV> from given halo mass Mh
    def MUV_from_Mh(self, cosmo, data, z, Mh):
        ...
        return (np.log10(epsilonstar * Mh / ((Mh/Mc)**alphastar + (Mh/Mc)**betastar)) - self.Mstar_fit_b[z]) / self.Mstar_fit_a[z] - self.Mstar_fit_anchor[z]
