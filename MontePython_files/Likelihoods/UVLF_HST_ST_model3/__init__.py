...
class UVLF_HST_ST_model3(Likelihood):
    ...
    def __init__(self, path, data, command_line):
        ...
        self.Mstar_fit_b = {4: 9.7, 5: 9.59, 6: 9.0, 7: 8.9, 8: 8.8, 9: 8.6, 10: 8.5}
        self.Mstar_fit_anchor = {
            4: 21,
            5: 21,
            6: 20.5,
            7: 20.5,
    ...
    def MUV_from_Mh(self, cosmo, data, z, Mh):
        ...
        return (
            np.log10(
                epsilonstar * Mh / ((Mh / Mc) ** alphastar + (Mh / Mc) ** betastar)
            )
            - self.Mstar_fit_b[z]
        ) / self.Mstar_fit_a[z] - self.Mstar_fit_anchor[z]
