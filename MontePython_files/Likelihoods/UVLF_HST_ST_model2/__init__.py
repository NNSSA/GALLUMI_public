...
class UVLF_HST_ST_model2(Likelihood):
    ...
    def MUV_from_Mh(self, cosmo, data, z, Mh):
        ...
        return -2.5 * np.log10(epsilonstar * Mh * cosmo.Hubble(z) * self.invMpctoinvYear / ((Mh/Mc)**alphastar + (Mh/Mc)**betastar) / self.kappaUV) + 51.63
