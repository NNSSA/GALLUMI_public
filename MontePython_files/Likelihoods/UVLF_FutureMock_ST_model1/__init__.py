...
class UVLF_FutureMock_ST_model1(Likelihood):
    ...
    def __init__(self, path, data, command_line):
        ...
        self.UVLF_FutureMock = np.loadtxt(data.path["data"]+"/UVLF/UVLF_FutureMock_WideField.txt") # Wide field mock data
    ...
    def AP_effect(self, data):
        ...
        for z in self.zs:
            ...
            Vratio =  (np.power(self.rcomoving(z+deltaz, self.Omega_m_FutureMock, self.h_FutureMock),3) - np.power(self.rcomoving(z-deltaz, self.Omega_m_FutureMock, self.h_FutureMock),3)) / (np.power(self.rcomoving(z+deltaz, Omega_m, hubble),3) - np.power(self.rcomoving(z-deltaz, Omega_m, hubble),3))
            ...
            self.UVLF_data[self.UVLF_data[:,0]==z,1] = self.UVLF_data[self.UVLF_data[:,0]==z,1] - 5. * np.log10(self.rcomoving(z, Omega_m, hubble) / self.rcomoving(z, self.Omega_m_FutureMock, self.h_FutureMock))
