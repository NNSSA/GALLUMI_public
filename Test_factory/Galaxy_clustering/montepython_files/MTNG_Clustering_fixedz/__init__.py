...
class MTNG_Clustering_fixedz(Likelihood):
    ...
    def cut_data(self, thetas, omegas, covs):
        pos_cuts = np.where((thetas <= 10) | (thetas > 100) & (thetas < 800))[0]
        # print(pos_single)
    ...
    def astro_parameters(self, data, z):
        ...
        Mc_central = 10 ** (data.mcmc_parameters["log10Mc_central_icept"]["current"])
